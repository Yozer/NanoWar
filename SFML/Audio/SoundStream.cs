...
namespace SFML.Audio
{
    ...
    public abstract class SoundStream : ObjectBase
    {
        ...
        [DllImport("csfml-audio-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfSoundStream_setPlayingOffset(IntPtr SoundStream, long TimeOffset);
        ...
        [DllImport("csfml-audio-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern long sfSoundStream_getPlayingOffset(IntPtr SoundStream);
