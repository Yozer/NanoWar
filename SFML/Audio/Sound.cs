...
namespace SFML.Audio
{
    ...
    public class Sound : ObjectBase
    {
        ...
        public SoundBuffer SoundBuffer
        {
            ...
            {
                myBuffer = value;
                sfSound_setBuffer(CPointer, value != null ? value.CPointer : IntPtr.Zero);
            }
        }
        ...
        [DllImport("csfml-audio-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern void sfSound_setPlayingOffset(IntPtr Sound, long TimeOffset);
        ...
        [DllImport("csfml-audio-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        private static extern long sfSound_getPlayingOffset(IntPtr Sound);
